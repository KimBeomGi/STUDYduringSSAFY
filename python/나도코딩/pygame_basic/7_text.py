...
# 스프라이트(캐릭터) 불러오기
character = pygame.image.load("C:/Users/dyd13/Desktop/my-today-ssafy-study/python/나도코딩/pygame_basic/character.png")
...
# 적 enemy 캐릭터
enemy = pygame.image.load("C:/Users/dyd13/Desktop/my-today-ssafy-study/python/나도코딩/pygame_basic/enemy.png")
...
# 10fps : 1초동안에 10번 동작 -> 1번에 몇 만큼 이동? 10만큼! 10 *10 = 100
# 20fps : 1초동안에 20번 동작 -> 1번에 몇 만큼 이동? 5만큼! 5*20 = 100
    ...
    # 타이머 집어 넣기
    # 경과 시간 계산
    elapsed_time = (pygame.time.get_ticks() - start_ticks) / 1000       #경과 시간(밀리세컨드ms)을 1000으로 나누어서 초 단위로 표시
