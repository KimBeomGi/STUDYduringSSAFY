...
while running:
    ...
    # 천장에 닿은 무기 없애기
    weapons = [ [w[0], w[1]] for w in weapons if w[1] > 0]      # 이 부분 헷갈릴 수 있으니까 연습도 해보고 공부도 해보고
    ...
    for ball_idx, ball_val in enumerate(balls):
        ...
        for weapon_idx, weapon_val in enumerate(weapons):
            ...
            if weapon_rect.colliderect(ball_rect):
                ...
                if ball_img_idx < 3:
                    ...
                    # 나눠진 공 정보
                    small_ball_rect = ball_images[ball_img_idx + 1].get_rect()      # 현재 인덱스보다 한단계 더 작아진 것을 잡아야하니까
        ...
        break           # 안쪽 for 문에서 break를 만나면 여기로 진입 가능. 2중 for문을 한번에 탈출하기 위함
...
# 2초 대기
pygame.time.delay(2000)                 # 이걸 해줘야 2ㅊ
