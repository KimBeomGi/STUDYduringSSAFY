...
import sys
three_num = list(map(int, sys.stdin.readline().strip().split()))

if three_num[0] + three_num[1] == three_num[2]:
    print(three_num[0],end='')
    print('+',end='')
    print(three_num[1],end='')
    print('=',end='')
    print(three_num[2])
elif three_num[0] - three_num[1] == three_num[2]:
    print(three_num[0],end='')
    print('-',end='')
    print(three_num[1],end='')
    print('=',end='')
...
###############
# 이런 방법도 있구만
a, b, c = map(int, input().split())     # a,b,c를 입력받음
# c가 a+b연산의 결과일 때
if a+b == c:
    print(f"{a}+{b}={c}")
elif a-b == c:
